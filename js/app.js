(() => {
    ...
    (() => {
        ...
        class SelectConstructor {
            ...
            getSelectTitleValue(selectItem, originalSelect) {
                ...
                if (originalSelect.hasAttribute("data-search")) return `<div class="${this.selectClasses.classSelectTitle}"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}"><input autocomplete="off" type="text" placeholder="${selectTitleValue}" data-placeholder="${selectTitleValue}" class="${this.selectClasses.classSelectInput}"></span></div>`; else {
                    ...
                    return `<button type="button" class="${this.selectClasses.classSelectTitle} _icon-triangle"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}${pseudoAttributeClass}"><span class="${this.selectClasses.classSelectContent}${customClass}">${selectTitleValue}</span></span></button>`;
                }
            }
        ...
        function initSliders() {
            if (document.querySelector(".mainscreen-slider")) new core(".mainscreen-slider", {
            ...
            if (document.querySelector(".stock-slider")) new core(".stock-slider", {
            ...
            if (document.querySelector(".seasonal-slider")) new core(".seasonal-slider", {
                modules: [ Navigation, Pagination, Grid ],
                observer: true,
                observeParents: true,
                spaceBetween: 20,
            ...
            if (document.querySelector(".gifts-slider")) new core(".gifts-slider", {
                modules: [ Navigation, Pagination, Grid ],
                observer: true,
                observeParents: true,
                spaceBetween: 20,
            ...
            if (document.querySelector(".forum-slider")) new core(".forum-slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                spaceBetween: 20,
            ...
            if (document.querySelector(".product-slider")) {
                var swiper = new core(".product-slider-thumbs", {
                    modules: [ freeMode ],
                    spaceBetween: 10,
                    slidesPerView: 4,
                    freeMode: true,
            ...
            if (document.querySelector(".related-slider")) new core(".related-slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                speed: 800,
            ...
            if (document.querySelector(".you-see-slider") && window.innerWidth > 480) new core(".you-see-slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                speed: 800,
...
***************************************************************************** */
        ...
        function pagination({posts, postsContainerClass, paginationWrapSelector, btnClass, data}) {
            ...
            function main(postsData) {
                ...
                function displayList(arrDataPseudo, rowPerPage, page) {
                    document.querySelector(postsContainerClass);
        ...
        function addClickableHeaderTop() {
            document.addEventListener("click", (e => {
                ...
                if (target.closest("[data-header-btn]")) toggleClass(target.closest("[data-header-item]"), "_active");
                if (!target.closest("[data-header-btn]")) removeClassForArray("[data-header-item]", "_active");
                if (target.closest("[data-change]")) changeList(target, "[data-visible]", "[data-parent-change]");
                if (target.closest(".search-header__btn")) addClass(target.closest(".search-header__input"), "_active");
                if (!target.closest(".search-header__input")) removeClassForArray(".search-header__input", "_active");
                if (target.closest("[data-check]")) toggleClass(target, "_active");
                if (target.closest(".slide-products__like button")) toggleClass(target.parentElement, "_active");
                if (target.closest("[data-count-l]")) counter(".action-product__num", "l");
                if (target.closest("[data-count-r]")) counter(".action-product__num", "r");
            }));
        }
        function changeList(el, visibleElSelector, parentElSelector) {
            const parentEl = el.closest(parentElSelector), visibleEl = parentEl.querySelector(visibleElSelector), changeLang = el.innerHTML;
        ...
        function counter(numClass, direction) {
            ...
            if ("l" === direction && num > 1) numWrap.innerHTML = num - 1;
            if ("r" === direction) numWrap.innerHTML = num + 1;
        }
        window["FLS"] = true;
        isWebp();
        menuInit();
        ...
        files_pagination({
            posts: 12,
            postsContainerClass: "#results",
            paginationWrapSelector: "#btnWrapper",
            btnClass: ".pagination-blog__dot",
            data: document.querySelectorAll(".catalog-products__product")
        });
    })();
})();